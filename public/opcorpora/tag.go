...
func Global_Dict_Init() {
	...
	POS_dict_int["NUM"] = "числительное"
	POS_dict_int["ADVB"] = "наречие"
	POS_dict_int["ADV"] = "наречие"
	POS_dict_int["NPRO"] = "местоимение-существительное"
	POS_dict_int["PRON"] = "местоимение-существительное"
	...
	POS_dict_int["CCONJ"] = "союз_координирующий"
	POS_dict_int["PRCL"] = "частица"
	POS_dict_int["PART"] = "частица"
	...
	POS_array_int = []string{
		...
		"число",
		"неопознанное",
		"имя_прилагательное_определитель",
		"союз_подчинительный",
	}
